...
public class WorkingPort {
    public static ProcessingResult findOptimalPortOperation(Timetable timetable) throws IOException {
        ...
        while (true) {
            ...
            scanRes.addNumberBulkShip(numberBULKShip.get());
            scanRes.addNumberLiquidShip(numberLIQUIDShip.get());
            scanRes.addNumberContainerShip(numberCONTAINERShip.get());
            ...
            scanRes.addCostBulk(totalCostForBULK.get() + numberCraneForBULK * Configuration.oneCraneFine);
            scanRes.addCostLiquid(totalCostForLIQUID.get() + numberCraneForLIQUID * Configuration.oneCraneFine);
            scanRes.addCostContainer(totalCostForCONTAINER.get() + numberCraneForCONTAINER * Configuration.oneCraneFine);

            scanRes.addNumberBulkCrane(numberCraneForBULK);
            scanRes.addNumberLiquidCrane(numberCraneForLIQUID);
            scanRes.addNumberContainerCrane(numberCraneForCONTAINER);
